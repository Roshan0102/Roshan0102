...
ROWS = [
    ("host",),
    ("kv", "Now", "Cloud & DevOps Engineer @ axcess.io"),
    ("kv", "Edu", "B.Tech AI & Data Science, Karunya '24"),
    ("kv", "Cert", "AWS Solutions Architect Associate"),
    ("gap",),
    ("sec", "Cloud & DevOps Stack"),
    ("kv", "IaC / Config", "Terraform, Ansible, CloudFormation"),
    ("kv", "CI/CD / GitOps", "GitHub Actions, ArgoCD, Jenkins"),
    ("kv", "Containers", "Docker, Kubernetes (EKS), Helm, Karpenter"),
    ("kv", "Observability", "Prometheus, Grafana, Loki, CloudWatch"),
    ("kv", "Scripting", "Python, Bash / Shell"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "30% cloud cost reduction via right-sizing & auto-scaling"),
    ("bul", "70% faster deployments via automated IaC & CI/CD"),
    ("bul", "Zero-downtime Azure-to-AWS migration (AWS MGN)"),
]
